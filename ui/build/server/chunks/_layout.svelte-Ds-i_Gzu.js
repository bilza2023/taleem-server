import { c as create_ssr_component, v as validate_component, a as subscribe, e as each, b as escape, n as null_to_empty, d as add_attribute, i as identity, o as onDestroy, m as missing_component, f as assign, g as noop } from './ssr-BKqIka7n.js';
import { t as toast } from './SvelteToast.svelte_svelte_type_style_lang-B7k2UuT-.js';
import { w as writable } from './index-ClERLwKE.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const options = {};
  return `${$$result.head += `<!-- HEAD_svelte-1k5wta0_START --><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4279476755172786" crossorigin="anonymous" data-svelte-h="svelte-6169bd"><\/script><!-- HEAD_svelte-1k5wta0_END -->`, ""}  ${validate_component(SvelteToast, "SvelteToast").$$render($$result, { options }, {}, {})} ${slots.default ? slots.default({}) : ``}`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-Ds-i_Gzu.js.map
